...
EMPATHIC_REACTIONS: dict[str, set[str]] = {
    ...
    "love":           {"love", "joy", "admiration", "approval"},
    "gratitude":      {"joy", "love", "admiration", "approval"},
    ...
    "sadness":        {"caring", "sadness", "love", "disappointment"},
...
DIRECTED_REACTIONS: dict[str, set[str]] = {
    ...
    "annoyance":      {"embarrassment", "remorse", "annoyance", "curiosity"},
    "disappointment": {"sadness", "remorse", "embarrassment", "caring"},
    "disapproval":    {"embarrassment", "sadness", "remorse", "anger", "curiosity"},
    "disgust":        {"embarrassment", "sadness", "remorse", "anger"},
    "sadness":        {"remorse", "caring", "embarrassment", "sadness"},
    "grief":          {"remorse", "caring", "love", "grief"},
